                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('facilities.update', $facility->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6">
                                    <x-translatable-field name="name" label="الاسم" :languages="config('app.locales')" :value="$facility->translations['name'] ?? []" required placeholder="أدخل الاسم" />
                                </div>

                                <div class="col-md-6">
                                    <x-translatable-field name="info" label="المعلومات" type="textarea" :languages="config('app.locales')" :value="$facility->translations['info'] ?? []" placeholder="أدخل المعلومات" />
                                </div>
